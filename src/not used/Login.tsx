...
export default function Login({ setHaveAcc, close }: loginProps) {
    ...
    return (
        <>
            <div className="login">
                <form action="POST" tabIndex={0} onSubmit={(e) => onSubmit(e)}>
                    <div className="auth-form">
                        ...
                        <p className="auth-p" onClick={() => setHaveAcc(previus=>!previus)}>
